...
class vision_layer(nn.Module):
    def __init__(self, hidden_dim):
        super(vision_layer, self).__init__()
        self.fc1 = nn.Linear(768, 768*2)
        self.layer_norm1 = nn.LayerNorm(768*2)  
        self.selu = nn.SELU()
        self.fc2 = nn.Linear(768*2, hidden_dim)
...
class GPT2Model(GPT2PreTrainedModel):
    def __init__(self, config):
        ...
        self.embed_dim = config.hidden_size
        self.vision_layer=vision_layer(self.embed_dim)
